...
export default function Page() {
	return (
		<div className="m-auto flex flex-col space-y-6 text-slate-800 md:max-w-lg md:items-center">
			<div className="flex flex-col space-y-4">
				<p>
					<span className="font-bold">I'm Nick</span>, a software engineer from
				...
				<p>
					I believe that <span className="font-bold">great software</span> is
					...
					and <span className="underline underline-offset-4">persistence</span>.
